...
<body onLoad='document.switchform.switch.focus();'>
	<script>
	...
	function disableInputs() {
		// disable input while loading (applying changes)
		document.getElementById('switch').readOnly = true;
		document.getElementById('port').readOnly = true;
		document.getElementById('vlan').readOnly = true;
		document.getElementById('voip').readOnly = true;
	...
	<div id='logincontainer'>
		...
		<div id='loginsplash'>
			...
			<form method='GET' name='switchform' onsubmit='beginFadeOutAnimation();'>
				<select name='switch' value='' id='switch' height='1' class='fullwidth hand bottommargin' onchange='this.form.submit(); beginFadeOutAnimation();'>
					<?php if($cSwitch == null) { ?>
				...
				<span class='dropdownarrow'><img src='img/dropdown.svg'></span>
				<?php
			...
			<form method='GET' name='portform' onsubmit='beginFadeOutAnimation();'>
				<div class='tooltip'>
					...
					<select name='port' value='' id='port' height='1' class='fullwidth hand bottommargin' onchange='this.form.submit(); beginFadeOutAnimation();' <?php if($cSwitch == null) echo "disabled"; ?>>
						<?php
			...
			<form method='POST' name='setvaluesform' onsubmit='beginFadeOutAnimation();'>
				...
				<div class='multirow'>
					<div>
						<select name='vlan' value='' id='vlan' class='hand bottommargin' <?php if($cSwitch == null || $port == "") echo "disabled"; ?>>
							<?php $selected = false; ?>
					...
					<div class='tooltip'>
						<select name='voip' value='' id='voip' class='hand bottommargin' <?php if ($cSwitch == null || $port == "") echo "disabled"; ?>>
				...
				<div class='tooltip'>
					<input type='text' name='description' id='description' maxlength='35' class='fullwidth bottommargin' value='<?php echo $desc ?>' <?php if($cSwitch == null || $port == "") echo "disabled"; ?>></input>
				...
				<button type='submit' class='slubbutton fullwidth bottommargin' id='submit_changeform' <?php if($cSwitch == null || $port == "") echo "disabled"; ?>>&gt;<?php translate('Save'); ?></button>
			</form>
